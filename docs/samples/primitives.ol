...
func draw()
    ...
    g.stroke(dim)
    g.fontSize(fs(13))
    g.text("stroke+fill", px(120), py(245))
    ...
    g.stroke(dim)
    g.fontSize(fs(13))
    g.text("polyline", px(30), py(340))

    ## 5e argument = rayon des coins, en pixels (borné à la moitié du petit côté)
    g.stroke(Color(0.9, 0.7, 1), fs(2))
    g.fill(Color(0.9, 0.7, 1, 0.22))
    g.rect(px(30), py(362), px(80), py(45), fs(14))
    g.stroke(dim)
    g.fontSize(fs(13))
    g.text("rect arrondi", px(120), py(378))
    ...
    g.stroke(dim)
    g.fontSize(fs(13))
    g.text("strokeSize", px(470), py(48))
    ...
    g.stroke(dim)
    g.fontSize(fs(13))
    g.text("push/pop/translate", px(476), py(246))
    g.stroke(dim)
    g.fontSize(fs(13))
    g.text("rotate/scale", px(490), py(262))

    g.stroke(dim)
    g.fontSize(fs(13))
    g.text("text", px(460), py(310))
