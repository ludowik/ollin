...
void register3d_graphics(Value& m) {
    ...
    m.map_set(Value(std::string("begin3d")), Value::make_builtin(with_area<gfx_begin3d>));
    m.map_set(Value(std::string("end3d")), Value::make_builtin(with_area<gfx_end3d>));
    ...
    m.map_set(Value(std::string("tileset")), Value::make_builtin(with_area<gfx_tileset>));
    ...
    m.map_set(Value(std::string("cylinder")), Value::make_builtin(with_area<gfx_cylinder>));
    m.map_set(Value(std::string("cone")), Value::make_builtin(with_area<gfx_cone>));
    m.map_set(Value(std::string("torus")), Value::make_builtin(with_area<gfx_torus>));
    m.map_set(Value(std::string("plane")), Value::make_builtin(with_area<gfx_plane>));
    m.map_set(Value(std::string("model")), Value::make_builtin(with_area<gfx_model>));
    m.map_set(Value(std::string("drawModel")), Value::make_builtin(with_area<gfx_draw_model>));
    m.map_set(Value(std::string("modelSize")), Value::make_builtin(with_area<gfx_model_size>));
    m.map_set(Value(std::string("fitDistance")), Value::make_builtin(gfx_fit_distance));
    m.map_set(Value(std::string("inFrustum")), Value::make_builtin(with_area<gfx_in_frustum>));
    m.map_set(Value(std::string("beginChunk")), Value::make_builtin(gfx_begin_chunk));
    m.map_set(Value(std::string("endChunk")), Value::make_builtin(with_area<gfx_end_chunk>));
    m.map_set(Value(std::string("drawChunk")), Value::make_builtin(with_area<gfx_draw_chunk>));
    m.map_set(Value(std::string("drawChunkAlpha")), Value::make_builtin(with_area<gfx_draw_chunk_alpha>));
    m.map_set(Value(std::string("freeChunk")), Value::make_builtin(with_area<gfx_free_chunk>));
    m.map_set(Value(std::string("line3d")), Value::make_builtin(with_area<gfx_line3d>));
    m.map_set(Value(std::string("point3d")), Value::make_builtin(with_area<gfx_point3d>));
    m.map_set(Value(std::string("rotateq")), Value::make_builtin(with_area<gfx_rotateq>));
