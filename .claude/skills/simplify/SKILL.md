...
Algorithme de résolution partagé avec `/code-review` — voir
`.claude/skills/_shared/review-target.md`. Repère de CETTE passe : `refs/simplified`
(distinct de `refs/reviewed`, propre à `/code-review` — les deux passes sont
